...
public class ArchiveProcessor {
    ...
    private void validateExtractInput(ArchiveModel archiveModel, ArchiveInput archiveInput) throws ArchiveException {
        validateInput(archiveModel, archiveInput, false);
    }

    private void validateArchiveInput(ArchiveModel archiveModel, ArchiveInput archiveInput) throws ArchiveException {
        validateInput(archiveModel, archiveInput, true);
    }

    private void validateInput(ArchiveModel archiveModel, ArchiveInput archiveInput, Boolean isArchive) throws ArchiveException {
        ...
        } else if (fileDirectory.isExist(archiveInput.destination) && isArchive) {
            throw new ArchiveException(ArchiveMessage.ARCHIVE_TO_EXIST);
        } else if (!fileDirectory.isExist(archiveInput.source) && !isArchive) {
    ...
    public void archive(ArchiveModel archiveModel, ArchiveInput archiveInput) throws ArchiveException {
        validateArchiveInput(archiveModel, archiveInput);
    ...
    public void extract(ArchiveModel archiveModel, ArchiveInput archiveInput) throws ArchiveException {
        validateExtractInput(archiveModel, archiveInput);
